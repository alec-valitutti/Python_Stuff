...
def music():
        ...
        if player.score == 9 and replay ==True:
                print(player.score,'player score')
                print(enemy.score,'enemy score')
                musicCounter +=10
                replay =False

        if enemy.score == 9 and replay ==True:
                print(player.score,'player score')
                print(enemy.score,'enemy score')
                musicCounter +=10
                replay =False
        ...
        if pygame.mixer.music.get_busy() == 0 and musicCounter ==4:
        ...
        if player.score ==9 and musicCounter >4:
                print(musicCounter)
                pygame.mixer.music.stop()
                pygame.mixer.music.load('music5.wav')
                pygame.mixer.music.play(-1)
        ...
        if enemy.score ==9 and musicCounter >4:
                print(musicCounter)
                pygame.mixer.music.stop()
                pygame.mixer.music.load('music5.wav')
                pygame.mixer.music.play(-1)
